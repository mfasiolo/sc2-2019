...
Now, assume that `expSmooth` is contained in a file called `expSmooth.c`, which in our case can be found in our working directory, as you can see from the following call to the command line (the output is hidden here): 
```{r}
system("ls *.c")
```
